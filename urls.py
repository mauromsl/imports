...
urlpatterns = [
    ...
    url(r'^jats/$', views.import_jats, name='import_jats'),
    url(r'^process/(?P<filename>[\w.-]{0,256})$',
        views.import_action, name='imports_action'),
    ...
    url(r'^csv_metadata_import/(?P<filename>[\w.-]{0,256})$',
        views.import_action, name='csv_metadata_import'),
